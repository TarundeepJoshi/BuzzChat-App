...
const MessageContainer = () => {
  ...
  useEffect(() => {
    ...
    const getChannelMessages = async () => {
      try {
        // console.log("Fetching messages for channel:", selectedChatData._id);
  ...
  const checkIfImage = (filePath) => {
    const imageRegex =
      /\.(jpeg|jpg|gif|png|bmp|tiff|tif|webp|svg|ico|heic|heif)$/;
          ...
          <div
            className={`${
              message.sender._id === userInfo._id
                ...
                : "bg-[2a2b33]/5 text-white/80 border-[#ffffff]/20"
            } border inline-block p-4 rounded ml-8 my-1 max-w-[50%] break-words`}
          >
            {message.content}
          </div>
        )}
